...
export class WorkspaceManager {
  ...
  async writeInstructions(agent: Agent): Promise<void> {
    const content = [
      ...
      "- Language Rule: Always respond in English when the user writes in English.",
      "- Focus directly on the user's prompt.",
      "- Always summarize the concrete workspace actions and file changes in your response.",
      "",
